...
const emails = [
  { content: "Your bank account has been suspended! Click here to reactivate.", correctAnswer: 1 },
  { content: "Congratulations! You've won a free gift! Claim it now!", correctAnswer: 1 },
  { content: "Urgent action required: Update your password immediately.", correctAnswer: 1 },
  ...
  { content: "Your Netflix subscription is about to expire. Update your payment details.", correctAnswer: 2 },
  { content: "You have a friend request from someone you know. Login to accept the request.", correctAnswer: 3 },
  { content:  "You have just won a lottery ticket. Visit the link to claim your reward.", correctAnswer: 1 },
  { content:  "You just received a bank transfer from a foriegn account. Login to your Bank account to confirm the transfer.", correctAnswer: 1 },
