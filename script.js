...
const emails = [
  { content: "Your bank account has been suspended! Click here to reactivate.", correctAnswer: 2 },
  { content: "Congratulations! You've won a free gift! Claim it now!", correctAnswer: 0 },
  { content: "Urgent action required: Update your password immediately.", correctAnswer: 0 },
  { content: "We noticed unusual activity on your account. Click here to verify.", correctAnswer: 1 },
  { content: "Your social media account needs immediate attention! Follow this link.", correctAnswer: 0 },
